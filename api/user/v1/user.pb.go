...
func (x *GetUserReply) GetGold() int32 {
	if x != nil {
		return x.Gold
	}
	return 0
...
func (x *GetUserReply) GetCreatedAt() int32 {
	if x != nil {
		return x.CreatedAt
	}
	return 0
...
type GetUserListReply struct {
	...
	List  []*GetUserReply `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
...
func (x *GetUserListReply) GetList() []*GetUserReply {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *GetUserByNameRequest) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *DeleteUserReply) GetBool() bool {
	if x != nil {
		return x.Bool
	}
	return false
...
func (x *ChangePasswordReply) GetBool() bool {
	if x != nil {
		return x.Bool
	}
	return false
...
var file_v1_user_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x67, 0x6f, 0x6c, 0x64,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x67, 0x6f, 0x6c, 0x64, 0x12, 0x1d, 0x0a, 0x0a,
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0x44, 0x0a, 0x12, 0x47,
	...
	0x65, 0x22, 0x57, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74,
	...
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x52, 0x04,
	0x6c, 0x69, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x22, 0x46, 0x0a, 0x14, 0x47, 0x65,
	...
	0x72, 0x64, 0x22, 0x59, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x70, 0x68, 0x6f, 0x6e, 0x65, 0x22, 0x1f, 0x0a,
	...
	0x79, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x6f, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x04, 0x62, 0x6f, 0x6f, 0x6c, 0x22, 0x66, 0x0a, 0x15, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50,
	...
	0x52, 0x0b, 0x6e, 0x65, 0x77, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x29, 0x0a,
	0x13, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52,
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x12, 0x0a, 0x04, 0x62, 0x6f, 0x6f, 0x6c, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x04, 0x62, 0x6f, 0x6f, 0x6c, 0x32, 0xd0, 0x03, 0x0a, 0x04, 0x55, 0x73, 0x65,
	0x72, 0x12, 0x41, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1b, 0x2e, 0x61,
	...
	0x65, 0x70, 0x6c, 0x79, 0x12, 0x4d, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x4c,
	...
	0x70, 0x6c, 0x79, 0x12, 0x4d, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42, 0x79,
	...
	0x6c, 0x79, 0x12, 0x47, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72,
	...
	0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x46, 0x0a, 0x0a, 0x44,
	...
	0x70, 0x6c, 0x79, 0x12, 0x56, 0x0a, 0x0e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x50, 0x61, 0x73,
	...
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x42, 0x2e, 0x0a, 0x0b, 0x61,
	0x70, 0x69, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x1d, 0x6b, 0x72,
	0x61, 0x74, 0x6f, 0x73, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f, 0x61, 0x70, 0x69,
...
var file_v1_user_proto_goTypes = []interface{}{
	...
	(*GetUserListRequest)(nil),    // 2: api.user.v1.GetUserListRequest
	(*GetUserListReply)(nil),      // 3: api.user.v1.GetUserListReply
	(*GetUserByNameRequest)(nil),  // 4: api.user.v1.GetUserByNameRequest
	(*CreateUserRequest)(nil),     // 5: api.user.v1.CreateUserRequest
	(*DeleteRequest)(nil),         // 6: api.user.v1.DeleteRequest
...
var file_v1_user_proto_depIdxs = []int32{
	1, // 0: api.user.v1.GetUserListReply.list:type_name -> api.user.v1.GetUserReply
	0, // 1: api.user.v1.User.GetUser:input_type -> api.user.v1.GetUserRequest
	2, // 2: api.user.v1.User.GetUserList:input_type -> api.user.v1.GetUserListRequest
	4, // 3: api.user.v1.User.GetUserByName:input_type -> api.user.v1.GetUserByNameRequest
	5, // 4: api.user.v1.User.CreateUser:input_type -> api.user.v1.CreateUserRequest
	6, // 5: api.user.v1.User.DeleteUser:input_type -> api.user.v1.DeleteRequest
	8, // 6: api.user.v1.User.ChangePassword:input_type -> api.user.v1.ChangePasswordRequest
	1, // 7: api.user.v1.User.GetUser:output_type -> api.user.v1.GetUserReply
	3, // 8: api.user.v1.User.GetUserList:output_type -> api.user.v1.GetUserListReply
	1, // 9: api.user.v1.User.GetUserByName:output_type -> api.user.v1.GetUserReply
	1, // 10: api.user.v1.User.CreateUser:output_type -> api.user.v1.GetUserReply
